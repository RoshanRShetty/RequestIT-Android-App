 ...
 */
public interface FindPlacesInterface extends Types, Statuses {
   ...
   // String API_KEY = "AIzaSyAROzJHM4Rc0UpAe2eFIEPZWSaoKwdBsjo";
     ...
     */
    List<Place> getNearbyPlaces(double lat, double lng, double radius, int limit,Attractions.PlaceResults place_results, Param... extraParams);
   ...
   // List<Place> getNearbyPlaces(double lat, double lng, double radius, Param... extraParams);
     ...
     * {@link com.ttu.appathon.request.places.exception.GooglePlacesException} will be thrown.
     *
     * @param place_results place_results
     * @param limit  the maximum amount of places to return
     ...
     * @throws com.ttu.appathon.request.places.exception.GooglePlacesException if 'keyword', 'name' or 'types' is not included.
     */
