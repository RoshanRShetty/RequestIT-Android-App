...
import com.ttu.appathon.request.places.Types;
import com.ttu.appathon.request.places.exception.GooglePlacesException;

import java.util.List;

/**
 * Interface to handle the  places
 */
public interface HotelsAPIInterface extends Types, Statuses {
     ...
     * A API KEY
     */
    String API_KEY = "AIzaSyCsF0oWNw0R05Ky7Pfmw2DkrRtA9vOs3D8";
   // String API_KEY = "AIzaSyAROzJHM4Rc0UpAe2eFIEPZWSaoKwdBsjo";
     ...
     *
     * @see com.ttu.appathon.request.places.Scope
     */
    ...
    /**
     * Returns the API key associated with this FindPlaces object.
     *
     * @return api key
     */
    String getApiKey();
    ...
    /**
     * Sets the API key associated with this FindPlaces object.
     *
     * @param apiKey to set
     */
     ...
     */
    List<HotelDetails> getNearbyPlaces(double lat, double lng, double radius, int limit, Accomadations.HotelResults hotel_results, Params... extraParams);
     ...
     * @param lng           longitude
     * @param radius        radius
     * @param hotel_results place_results
     * @param extraParams any extra parameters to include in the request URL
     * @return a list of places that were found
     */
   ...
   // List<Place> getNearbyPlaces(double lat, double lng, double radius, Param... extraParams);
     ...
     * {@link GooglePlacesException} will be thrown.
     *
     * @param place_results place_results
     * @param limit  the maximum amount of places to return
     ...
     * @throws GooglePlacesException if 'keyword', 'name' or 'types' is not included.
     */
    HotelDetails getPlaceById(String placeId, Params... extraParams);
