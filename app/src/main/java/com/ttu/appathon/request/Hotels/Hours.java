...
public class Hours {
    ...
    public static class Period {
        private com.ttu.appathon.request.places.Day openingDay, closingDay;
         ...
         * @return opening day
         */
        public com.ttu.appathon.request.places.Day getOpeningDay() {
            return openingDay;
        }
         ...
         * @return this
         */
        protected Period setOpeningDay(com.ttu.appathon.request.places.Day openingDay) {
         ...
         * @return closing day
         */
        public com.ttu.appathon.request.places.Day getClosingDay() {
            return closingDay;
        }
