...
import static com.ttu.appathon.request.places.FindPlaces.MAX_PHOTO_SIZE;
...
public class Photo {
     ...
     * @return this
     */
    public Bitmap download(int maxWidth, int maxHeight, Param... extraParams) {
        return place.getClient().downloadPhoto(this, maxWidth, maxHeight, extraParams);
