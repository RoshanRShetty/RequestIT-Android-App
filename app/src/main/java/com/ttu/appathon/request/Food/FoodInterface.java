package com.ttu.appathon.request.Food;
 ...
 */
public interface FoodInterface extends Types, Statuses {
     ...
     * A Google API KEY
     */
    String API_KEY = "189ac73a52a3ee1a46826c9f9ebe2cb8";
     ...
     */
    List<RestaurantDetailsJsonParser> getNearbyPlaces(double lat, double lng, double radius, int limit, Params... extraParams);
     ...
     * @return a list of places that were found
     */
    //List<RestaurantDetailsJsonParser> getNearbyPlaces(double lat, double lng, double radius, Param... extraParams);
     ...
     */
  //  List<Place> getNearbyPlacesRankedByDistance(double lat, double lng, int limit, Params... params)
...
//    List<Place> getPlacesByQuery(String query, Param... extraParams);
     ...
     * @return a list of places that were found
     */
 //   RestaurantDetailsJsonParser getPlaceById(String placeId, Params... extraParams);
